...
var AudiencesRouter = exports.AudiencesRouter = function (_ClassesRouter) {
  ...
  _createClass(AudiencesRouter, [{
    ...
    value: function mountRoutes() {
      ...
      this.route('GET', '/push_audiences', function (req) {
        return _this2.handleFind(req);
      });
      this.route('GET', '/push_audiences/:objectId', function (req) {
        return _this2.handleGet(req);
      });
      this.route('POST', '/push_audiences', function (req) {
        return _this2.handleCreate(req);
      });
      this.route('PUT', '/push_audiences/:objectId', function (req) {
        return _this2.handleUpdate(req);
      });
      this.route('DELETE', '/push_audiences/:objectId', function (req) {
