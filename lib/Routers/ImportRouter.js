...
var ImportRouter = exports.ImportRouter = function () {
  ...
  _createClass(ImportRouter, [{
    ...
    value: function getRestObjects(req) {
      return new Promise(function (resolve) {
        ...
        try {
          ...
          throw new _node.Parse.Error(_node.Parse.Error.INTERNAL_SERVER_ERROR, 'Failed to parse JSON based on the file sent');
        }
        ...
        if (restObjects.length === 0) {
          throw new _node.Parse.Error(_node.Parse.Error.INTERNAL_SERVER_ERROR, 'No data to import');
        }
    ...
    value: function handleImport(req) {
      ...
      var emailControllerAdapter = (0, _AdapterLoader.loadAdapter)(req.config.emailAdapter);
