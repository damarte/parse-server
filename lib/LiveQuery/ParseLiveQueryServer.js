...
var ParseLiveQueryServer = function () {
  ...
  _createClass(ParseLiveQueryServer, [{
    ...
    value: function _onAfterDelete(message) {
      ...
      _PLog2.default.verbose(_node2.default.applicationId + 'afterDelete is triggered');
    ...
    value: function _onAfterSave(message) {
      ...
      _PLog2.default.verbose(_node2.default.applicationId + 'afterSave is triggered');
