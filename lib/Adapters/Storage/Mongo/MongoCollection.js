...
var MongoCollection = function () {
  ...
  _createClass(MongoCollection, [{
    ...
    value: function find(query) {
      ...
      var sort = _ref.sort;
      var readPreference = _ref.readPreference;

      return this._rawFind(query, { skip: skip, limit: limit, sort: sort, readPreference: readPreference }).catch(function (error) {
        ...
        // Retry, but just once.
        .then(function () {
          return _this._rawFind(query, { skip: skip, limit: limit, sort: sort, readPreference: readPreference });
        });
      });
    }
  }, {
    ...
    value: function _rawFind(query) {
      ...
      var sort = _ref2.sort;
      var readPreference = _ref2.readPreference;

      return this._mongoCollection.find(query, { skip: skip, limit: limit, sort: sort, readPreference: readPreference }).toArray();
    }
  }, {
    key: 'count',
    value: function count(query) {
      ...
      var sort = _ref3.sort;
      var readPreference = _ref3.readPreference;

      return this._mongoCollection.count(query, { skip: skip, limit: limit, sort: sort, readPreference: readPreference });
    }
  }, {
    key: 'insertOne',
