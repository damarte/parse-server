...
var MongoStorageAdapter = exports.MongoStorageAdapter = function () {
  ...
  function MongoStorageAdapter(_ref2) {
    var _ref2$uri = _ref2.uri,
        uri = _ref2$uri === undefined ? DefaultMongoURI : _ref2$uri,
  ...
  _createClass(MongoStorageAdapter, [{
    ...
    value: function find(className, schema, query, _ref4) {
      ...
      return this._adaptiveCollection(className).then(function (collection) {
        return collection.find(mongoWhere, { skip: skip, limit: limit, sort: mongoSort, readPreference: readPreference });
    ...
    value: function count(className, schema, query) {
      ...
      var readPreference = this._geoQueryOnSecondary && extraOut.hasGeoQuery ? ReadPreference.SECONDARY_PREFERRED : undefined;
      return this._adaptiveCollection(className).then(function (collection) {
        return collection.count(mongoWhere, { readPreference: readPreference });
      });
    }
  }]);
