...
var MongoStorageAdapter = exports.MongoStorageAdapter = function () {
  ...
  function MongoStorageAdapter(_ref2) {
    var _ref2$uri = _ref2.uri,
        ...
        _ref2$geoQueryOnSecon = _ref2.geoQueryOnSecondary,
        geoQueryOnSecondary = _ref2$geoQueryOnSecon === undefined ? false : _ref2$geoQueryOnSecon,
        _ref2$readOnSecondary = _ref2.readOnSecondaryClasses,
        readOnSecondaryClasses = _ref2$readOnSecondary === undefined ? [] : _ref2$readOnSecondary,
        _ref2$cachedCollectio = _ref2.cachedCollections,
        cachedCollections = _ref2$cachedCollectio === undefined ? {} : _ref2$cachedCollectio,
        _ref2$cacheController = _ref2.cacheController,
        cacheController = _ref2$cacheController === undefined ? null : _ref2$cacheController;
  ...
  _createClass(MongoStorageAdapter, [{
    ...
    value: function _adaptiveCollection(name) {
      ...
      return this.connect().then(function () {
        ...
        return new _MongoCollection2.default(rawCollection, _this2._cachedCollections, _this2._cacheController);
      });
    }
  }, {
    ...
    value: function find(className, schema, query, _ref4) {
      ...
      schema = convertParseSchemaToMongoSchema(schema);
      var extraOut = {};
      var mongoWhere = (0, _MongoTransform.transformWhere)(className, query, schema, extraOut);
      ...
      if (readPreference) {
        ...
        readPreference = this._geoQueryOnSecondary && extraOut.hasGeoQuery || this._readOnSecondaryClasses && this._readOnSecondaryClasses.indexOf(className) >= 0 || extraOut.hasRegex || limit > 100 ? ReadPreference.SECONDARY_PREFERRED : undefined;
      }
      return this._adaptiveCollection(className).then(function (collection) {
        return collection.find(mongoWhere, { skip: skip, limit: limit, sort: mongoSort, keys: mongoKeys, readPreference: readPreference, maxTimeMS: _this7._maxTimeMS });
    ...
    value: function count(className, schema, query) {
      ...
      var extraOut = {};
      var mongoWhere = (0, _MongoTransform.transformWhere)(className, query, schema, extraOut);
      var readPreference = this._geoQueryOnSecondary && extraOut.hasGeoQuery || extraOut.hasRegex ? ReadPreference.SECONDARY_PREFERRED : undefined;
      readPreference = ReadPreference.SECONDARY_PREFERRED;
      return this._adaptiveCollection(className).then(function (collection) {
        return collection.count(mongoWhere, { readPreference: readPreference, maxTimeMS: _this9._maxTimeMS });
      });
    }
  }, {
