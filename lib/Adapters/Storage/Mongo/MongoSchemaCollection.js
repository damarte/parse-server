...
var MongoSchemaCollection = function () {
  ...
  _createClass(MongoSchemaCollection, [{
    ...
    value: function _fetchAllSchemasFrom_SCHEMA() {
      return this._collection._rawFind({}, { readPreference: 'SECONDARY_PREFERRED' }).then(function (schemas) {
    ...
    value: function _fechOneSchemaFrom_SCHEMA(name) {
      return this._collection._rawFind(_mongoSchemaQueryFromNameQuery(name), { limit: 1, readPreference: 'SECONDARY_PREFERRED' }).then(function (results) {
        if (results.length === 1) {
