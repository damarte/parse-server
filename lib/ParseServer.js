...
var ImportRouter = _interopRequireWildcard(_ImportRouter);

var _ImportRelationRouter = require('./Routers/ImportRelationRouter');

var ImportRelationRouter = _interopRequireWildcard(_ImportRelationRouter);
...
var ParseServer = function () {
  function ParseServer(_ref) {
    var _ref$appId = _ref.appId,
        ...
        geoQueryOnSecondary = _ref.geoQueryOnSecondary,
        readOnSecondaryClasses = _ref.readOnSecondaryClasses,
        cachedCollections = _ref.cachedCollections,
    ...
    if ((databaseOptions || databaseURI && databaseURI != _defaults2.default.DefaultMongoURI || collectionPrefix !== '' || geoQueryOnSecondary !== undefined || readOnSecondaryClasses !== undefined || cachedCollections !== undefined) && databaseAdapter) {
  ...
  _createClass(ParseServer, [{
    ...
    value: function getDatabaseAdapter(databaseURI, collectionPrefix, databaseOptions, geoQueryOnSecondary, readOnSecondaryClasses, cachedCollections, cacheController) {
      var protocol = void 0;
      try {
      ...
      switch (protocol) {
        ...
        default:
          return new _MongoStorageAdapter2.default({
            ...
            geoQueryOnSecondary: geoQueryOnSecondary,
            readOnSecondaryClasses: readOnSecondaryClasses,
