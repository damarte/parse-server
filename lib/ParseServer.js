...
var ParseServer = function () {
  function ParseServer(_ref) {
    ...
    if ((databaseOptions || databaseURI && databaseURI != _defaults2.default.DefaultMongoURI || collectionPrefix !== '' || geoQueryOnSecondary !== undefined) && databaseAdapter) {
  ...
  _createClass(ParseServer, [{
    ...
    value: function getDatabaseAdapter(databaseURI, collectionPrefix, databaseOptions, geoQueryOnSecondary) {
      var protocol = void 0;
      try {
